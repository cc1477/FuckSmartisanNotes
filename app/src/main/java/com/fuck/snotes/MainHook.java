  ...
  private void hookField(DexKitBridge bridge, String fieldName, Class<?> fieldType, Object value) {
    try {
      Field field =
          bridge
              .findField(
                  FindField.create().matcher(FieldMatcher.create().name(fieldName).type(fieldType)))
              .single()
                  ...
                  FindMethod.create()
                      .matcher(
                          MethodMatcher.create()
                              .name("isVip")
                              .usingFields(Collections.singleton(fieldMatcher))))
              .single()
          ...
          bridge
              .findMethod(
                  FindMethod.create()
                      ...
                      .matcher(
                          MethodMatcher.create()
                              .declaredClass("com.smartisan.notes.Splash")
                  ...
                  FindMethod.create()
                      ...
                      .matcher(
                          MethodMatcher.create()
                              ...
                              .declaredClass("com.ss.android.update.UpdateServiceImpl")))
              .single()
              .getMethodInstance(hostClassLoader);
                  ...
                  FindMethod.create()
                      .matcher(
                          MethodMatcher.create()
                              ...
                              .declaredClass("com.smartisanos.notes.widget.SensitiveWordManager")))
              .single()
              .getMethodInstance(hostClassLoader);
